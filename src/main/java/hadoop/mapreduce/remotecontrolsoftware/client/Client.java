...
public class Client extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button disconnectButton = new Button("Se deconnecter"); // Bouton pour se déconnecter
        ...
        Label responseLabel = new Label("Reponses du Serveur");
    ...
    private void uploadFile(Stage stage) {
        ...
        if (file != null) { // Si un fichier est sélectionné
            new Thread(() -> { // Lance l’upload dans un thread séparé
                ...
                try {
                    log("Envoi du fichier : " + file.getName()); // Log le début
